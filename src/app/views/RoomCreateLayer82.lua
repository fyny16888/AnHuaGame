...
function RoomCreateLayer:onCreate(parameter)
    ...
    local csb = cc.CSLoader:createNode("RoomCreateLayer82.csb")
    self:addChild(csb)
    ...
    if self.recordCreateParameter["mBanBanHu"] ~= nil and self.recordCreateParameter["mBanBanHu"] == 1 then 
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["mJiangJiangHu"] ~= nil and self.recordCreateParameter["mJiangJiangHu"] == 1 then 
        items[2]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["bQiDui"] == nil or self.recordCreateParameter["bQiDui"] == 0 then 
        items[4]:setEnabled(false)
        items[4]:setColor(cc.c3b(170,170,170))
    ...
    elseif self.recordCreateParameter["bHaoHuaQiDui"] ~= nil and self.recordCreateParameter["bHaoHuaQiDui"] == 1 then 
    ...
    if self.recordCreateParameter["bGangShangPao"] ~= nil and self.recordCreateParameter["bGangShangPao"] == 1 then 
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["bQingYiSe"] ~= nil and self.recordCreateParameter["bQingYiSe"] == 1 then 
        items[3]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    Common:addCheckTouchEventListener(items,true,function(index) 
        if index == 2 then       
            ...
            if target:isBright() then
                ...
                local items_8 = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(7),"ListView_parameter"):getItems()               
                if items_8[1]:isBright() or items_8[2]:isBright()  or items_8[3]:isBright() then
    ...
    if self.recordCreateParameter["mLaiZiCount"] == nil or self.recordCreateParameter["mLaiZiCount"] == 0 then 
        items[4]:setEnabled(false)
        items[4]:setBright(false)
        items[4]:setColor(cc.c3b(170,170,170))
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1], "Text_desc")
    ...
    elseif self.recordCreateParameter["bSiHZHu"] ~= nil and self.recordCreateParameter["bSiHZHu"] == 1 then 
        items[4]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[4],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    Common:addCheckTouchEventListener(items,false,function(index) 
        ...
        local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(12),"ListView_parameter"):getItems()
        if  index == 1 or index == 2 or index == 3  then
            local items_4 = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(4),"ListView_parameter"):getItems()               
            if items_4[2]:isBright() then
                items[1]:setEnabled(true)
                items[1]:setColor(cc.c3b(255,255,255))
            end 
    ...
    if self.recordCreateParameter["bMaType"] == 7 or self.recordCreateParameter["bMaType"] == 0  then
        for key, var in pairs(items) do
            var:setBright(false)
            local uiText_desc = ccui.Helper:seekWidgetByName(var,"Text_desc")
            if uiText_desc ~= nil then 
    ...
    elseif self.recordCreateParameter["bMaType"] ~= nil and self.recordCreateParameter["bMaType"] == 2 then
        items[2]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    elseif self.recordCreateParameter["bMaType"] == nil or self.recordCreateParameter["bMaType"] == 1 then
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["bMaType"] ~= 4 and self.recordCreateParameter["bMaType"] == 0  then
        for key, var in pairs(items) do
            var:setBright(false)
            local uiText_desc = ccui.Helper:seekWidgetByName(var,"Text_desc")
            if uiText_desc ~= nil then 
    ...
    elseif self.recordCreateParameter["bMaCount"] == nil or self.recordCreateParameter["bMaCount"] == 1 then
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["bMaType"] ~= nil and self.recordCreateParameter["bMaType"] == 7 then
        for i= 3 , 4 do
            items[i]:setBright(false)
            items[i]:setEnabled(false)
            items[i]:setColor(cc.c3b(170,170,170))
    ...
    local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(10),"ListView_parameter"):getItems()
    Common:addCheckTouchEventListener(items)   
    if self.recordCreateParameter["mNiaoType"] ~= nil and self.recordCreateParameter["mNiaoType"] == 2 then
        items[2]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
        end    
    elseif self.recordCreateParameter["mNiaoType"] == nil or self.recordCreateParameter["mNiaoType"] == 1 then
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(12),"ListView_parameter"):getItems()
    Common:addCheckTouchEventListener(items,true)
    if self.recordCreateParameter["mHongNiao"] ~= nil and self.recordCreateParameter["mHongNiao"] == 1 then
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
...
function RoomCreateLayer:onEventCreate(nTableType)
    ...
    local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(2),"ListView_parameter"):getItems()
    if items[1]:isBright() then
        tableParameter.mBanBanHu = 1
    else
        tableParameter.mBanBanHu = 0
    end
    if items[2]:isBright() then
        tableParameter.mJiangJiangHu = 1
    else
        tableParameter.mJiangJiangHu = 0
    end
    ...
    if items[4]:isBright() then
        tableParameter.bHaoHuaQiDui = 1
    else
        tableParameter.bHaoHuaQiDui = 0
    end

    local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(3),"ListView_parameter"):getItems()
    if items[1]:isBright() then
        tableParameter.bGangShangPao = 1
    else
        tableParameter.bGangShangPao = 0
    end
    if items[2]:isBright() then
    ...
    -- local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(5),"ListView_parameter"):getItems()
    if items[4]:isBright() then
        tableParameter.bSiHZHu = 1
    else
        tableParameter.bSiHZHu = 0
    end
