...
function RoomCreateLayer:onCreate(parameter)
    ...
    local csb = cc.CSLoader:createNode("RoomCreateLayer80.csb")
    self:addChild(csb)
    ...
    if self.recordCreateParameter["mZXFlag"] ~= nil and self.recordCreateParameter["mZXFlag"] == 1 then 
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["bXHBJPFlag"] ~= nil and self.recordCreateParameter["bXHBJPFlag"] == 1 then
    ...
    if self.recordCreateParameter["mZTSXlag"] ~= nil and self.recordCreateParameter["mZTSXlag"] == 1 then
        items[2]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    if self.recordCreateParameter["mJTYNFlag"] ~= nil and self.recordCreateParameter["mJTYNFlag"] == 1 then
        items[3]:setBright(true)
        items[3]:setColor(cc.c3b(255,255,255))
        local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
        if uiText_desc ~= nil then 
    ...
    if self.recordCreateParameter["mZTLLSFlag"] ~= nil and self.recordCreateParameter["mZTLLSFlag"] == 1 then
        items[4]:setBright(true)
        items[4]:setColor(cc.c3b(255,255,255))
        local uiText_desc = ccui.Helper:seekWidgetByName(items[4],"Text_desc")
        if uiText_desc ~= nil then 
    ...
    if self.recordCreateParameter["bJJHFlag"] ~= nil and self.recordCreateParameter["bJJHFlag"] == 1 then
        items[2]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    elseif self.recordCreateParameter["bMaType"] ~= nil and self.recordCreateParameter["bMaType"] == 1 then
        items[3]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    elseif self.recordCreateParameter["bMaCount"] ~= nil and self.recordCreateParameter["bMaCount"] == 1 then
        items[1]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[1],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    elseif self.recordCreateParameter["bQGHu"] ~= nil and self.recordCreateParameter["bMaCount"] == 4 then
        items[3]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
    ...
    Common:addCheckTouchEventListener(items)
    if self.recordCreateParameter["mKGNPFlag"] ~= nil and self.recordCreateParameter["mKGNPFlag"] == 4 then
        items[2]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
        end  
    elseif self.recordCreateParameter["mKGNPFlag"] ~= nil and self.recordCreateParameter["mKGNPFlag"] == 6 then
        items[3]:setBright(true)
        local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
        if uiText_desc ~= nil then 
            uiText_desc:setTextColor(cc.c3b(215,86,31))
...
function RoomCreateLayer:onEventCreate(nTableType)
    ...
    if items[4]:isBright() then
        tableParameter.bXHBJPFlag = 1
    else
        tableParameter.bXHBJPFlag = 0
    end
    ...
    if items[3]:isBright() then
        tableParameter.mJTYNFlag = 1
    else
        tableParameter.mJTYNFlag = 0
    end
    if items[4]:isBright() then
        tableParameter.mZTLLSFlag = 1
    else
        tableParameter.mZTLLSFlag = 0
    end
    ...
    local items = ccui.Helper:seekWidgetByName(uiListView_parameterList:getItem(10),"ListView_parameter"):getItems()
    if items[1]:isBright() then
        tableParameter.mKGNPFlag = 2
    elseif items[2]:isBright() then
        tableParameter.mKGNPFlag = 4
    elseif items[3]:isBright() then
        tableParameter.mKGNPFlag = 6
    end
    ...
    tableParameter.bDSXFlag = 1     --大四喜   默认1.是
