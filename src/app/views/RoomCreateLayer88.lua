...
function RoomCreateLayer:onCreate(parameter)
    ...
    local csb = cc.CSLoader:createNode("RoomCreateLayer88.csb")
    self:addChild(csb)
    ...
    Common:addCheckTouchEventListener({uiButton_deathCard},true)
     ...
     Common:addCheckTouchEventListener(items)
     if self.recordCreateParameter["bZhuangFen"] ~= nil and self.recordCreateParameter["bZhuangFen"] == 2 then
         items[2]:setBright(true)
         local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
         if uiText_desc ~= nil then 
             uiText_desc:setTextColor(cc.c3b(215,86,31))
         end
     elseif self.recordCreateParameter["bZhuangFen"] ~= nil and self.recordCreateParameter["bZhuangFen"] == 5 then
         items[3]:setBright(true)
         local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
         if uiText_desc ~= nil then 
             uiText_desc:setTextColor(cc.c3b(215,86,31))
         end
     elseif self.recordCreateParameter["bZhuangFen"] ~= nil and self.recordCreateParameter["bZhuangFen"] == 10 then
     ...
     if self.recordCreateParameter["dwMingTang"] ~= nil and Bit:_and(0x00000001,self.recordCreateParameter["dwMingTang"]) ~= 0 then
         items[2]:setBright(true)
         local uiText_desc = ccui.Helper:seekWidgetByName(items[2],"Text_desc")
         if uiText_desc ~= nil then 
             uiText_desc:setTextColor(cc.c3b(215,86,31))
     ...
     if self.recordCreateParameter["bChiNoPeng"] ~= nil and self.recordCreateParameter["bChiNoPeng"] == 1 then
         items[3]:setBright(true)
         local uiText_desc = ccui.Helper:seekWidgetByName(items[3],"Text_desc")
         if uiText_desc ~= nil then 
             uiText_desc:setTextColor(cc.c3b(215,86,31))
...
function RoomCreateLayer:onEventCreate(nTableType)
    ...
    if items[1]:isBright() then
        tableParameter.bZhuangFen = 0
    elseif items[2]:isBright() then
        tableParameter.bZhuangFen = 2
    elseif items[3]:isBright() then
        tableParameter.bZhuangFen = 5
    elseif items[4]:isBright() then
        tableParameter.bZhuangFen = 10
    else
        return
    end
    ...
    if items[2]:isBright() then
        tableParameter.dwMingTang = 0x00000001
    else
        tableParameter.dwMingTang = 0
    end
    if items[3]:isBright() then
        tableParameter.bChiNoPeng = 1
    else
        tableParameter.bChiNoPeng = 0
    end
