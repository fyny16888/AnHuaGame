...
mkdir 正式包\res\achannel\25
xcopy res\achannel\25 正式包\res\achannel\25 /e
...
mkdir 渠道25
xcopy 正式包 渠道25 /e
mkdir 正式包\src\version\25
mkdir 渠道25\src\version\25
copy ".\src\version\25\*" ".\渠道25\src\version\25\"
:这里删除不需要的文件夹，例如：rd /s/q 文件名
start /wait VerstionBuild.exe 渠道25\ 渠道25\src\version\25\version.manifest 渠道25\src\version\25\project.manifest
copy ".\渠道25\src\version\25\*" ".\正式包\src\version\25\"
